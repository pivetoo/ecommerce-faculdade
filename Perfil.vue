...
<style scoped>
  ...
  .perfil-content {
    ...
    padding: 60px; /* Aumentado para mais espaço interno */
    border-radius: 10px;
    box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1);
    width: 90vw; /* Aumenta para preencher mais a largura da tela */
    max-width: 1500px; /* Limita a largura máxima */
    min-height: 90vh; /* Aumenta a altura para preencher mais a tela */
  }
  
  .perfil-imagem {
    margin-bottom: 40px; /* Aumentado o espaçamento abaixo da imagem */
  }
  
  .perfil-imagem img {
    width: 250px; /* Aumentado o tamanho da imagem */
    height: 250px; /* Aumentado o tamanho da imagem */
    border-radius: 50%;
    object-fit: cover;
  }
  ...
  .perfil-info {
    width: 100%;
    max-width: 800px; /* Aumentado o tamanho do container das informações */
    display: flex;
    flex-direction: column;
    align-items: center;
  }
  ...
  .form-group {
    margin-bottom: 25px; /* Aumentado o espaço entre os campos */
    width: 100%;
  }
  
  .form-group label {
    font-size: 1.2rem; /* Aumentado o tamanho da fonte dos rótulos */
    display: block;
    font-weight: bold;
    margin-bottom: 10px;
    text-align: left;
  ...
  .form-group input {
    font-size: 1.2rem; /* Aumentado o tamanho da fonte dos inputs */
    width: 100%;
    padding: 15px; /* Aumentado o padding interno dos campos */
  ...
  button {
    font-size: 1.2rem; /* Aumentado o tamanho da fonte do botão */
  ...
  .erro {
    color: red;
    font-size: 1rem; /* Aumentado o tamanho da fonte das mensagens de erro */
    margin-top: 5px;
  }
</style>
